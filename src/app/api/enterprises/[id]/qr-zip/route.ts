...
/** Bundle every store QR code for an enterprise into a single ZIP. */
export async function GET(req: Request, { params }: RouteContext) {
  ...
  // Generate sequentially to bound memory/CPU for very large enterprises.
  ...
  return new NextResponse(new Uint8Array(buffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="qr-codes-${id}.zip"`,
